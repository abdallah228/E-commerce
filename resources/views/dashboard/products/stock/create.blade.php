                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> المستودع
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> أضافة  بيانات المستودع </h4>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="sku"
                                                                   ...
                                                                   value="{{$stock_details->sku??old('sku')}}"
                                                                   name="sku">
                                                            @error("sku")
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="manage_stock" class="select2 form-control" id="manageStock">
                                                                <optgroup label="من فضلك أختر النوع ">
                                                                    <option value="0" {{$stock_details->manage_stock == 0 ? 'selected' : ''}}>عدم اتاحه التتبع</option>
                                                                    <option value="1" {{$stock_details->manage_stock == 1 ? 'selected' : ''}}>اتاحة التتبع</option>
                                                                </optgroup>
                                                            </select>
                                                            @error('manage_stock')
                                                            <span class="text-danger"> {{$message}}</span>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="in_stock" class="select2 form-control" >
                                                                <optgroup label="من فضلك أختر  ">
                                                                    <option value="1"{{$stock_details->in_stock == 1 ? 'selected' : ''}}>متاح</option>
                                                                    <option value="0" {{$stock_details->in_stock == 0 ? 'selected' : ''}}>غير متاح </option>
                                                                </optgroup>
                                                            </select>
                                                            @error('in_stock')
                                                            <span class="text-danger"> {{$message}}</span>
                                                    ...
                                                    <div class="col-md-6" style="display:none"  id="qtyDiv">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="sku"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   value="{{$stock_details->qty??old('qty')}}"
                                                                   name="qty">
                                                            @error("qty")
                                                            <span class="text-danger">{{$message}}</span>
                                                            @enderror
