...
<div class="app-content content">
        <div class="content-wrapper">
            ...
            <div class="content-body">
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        <form class="form" action="{{route('shipping.setting.update',$ShippingMethod->id)}}"
                                method="PUT"
        ...
        <input type="text" value="{{$ShippingMethod->value}}" id="name"class="form-control"placeholder=" "name="name">
                                @error("name")
