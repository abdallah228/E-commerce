                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('admin.subcategories')}}"> الاقسام الرئيسية </a>
                                </li>
                                        ...
                                        <form class="form"
                                            ...
                                            <div class="form-group">
                                                <div class="text-center">
                                                    <img
                                                        src="{{asset('admin/images/categories/'.$subCategory -> photo)}}"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group mt-1">
                                                            <input type="checkbox" value="{{$subCategory->is_active}}"
                                                                   name="is_active"
                                                                   id="switcheryColor4"
                                                                   class="switchery" data-color="success"
                                                                   @if($subCategory -> is_active == 1)checked @endif/>
                                                            <label for="switcheryColor4"
                                                                   class="card-title ml-1">الحاله({{$subCategory->getActive()}})</label>
